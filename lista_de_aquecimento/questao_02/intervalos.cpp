//////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Escreva um programa em C/C++ chamado intervalos.cpp que le um numero nao conhecido de valores, 
// um de cada vez, e conta quantos deles estao em cada um dos intervalos [0, 25), [25, 50), [50, 75) e [75, 100].
// Para encerrar a entrada de dados o usuario deve pressionar <Ctrl+d>
//
// Comando para compilar: g++ -Wall intervalos.cpp -o intervalos
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
int main()
{
	...
	/* Recebe valores inteiros até o usuário digitar "CTRL+D" */
	while( std::cin >> num )
	{
